...
<div id="voteModal" class="custom-modal">
  <div class="custom-modal-content">
    ...
    <div class="custom-modal-body">
      <input type="text" id="voteTitle" class="input-field" placeholder="투표 제목">
      <!-- 항목 입력란이 추가될 공간 -->
      <div id="voteItems">
        <div class="vote-item">
          <input type="text" class="input-field" placeholder="항목 입력">
        </div>
        <div class="vote-item">
          <input type="text" class="input-field" placeholder="항목 입력">
        </div>
      ...
      <!-- 항목 추가 버튼 -->
      <button class="add-item-button" onclick="addVoteItem()">+ 항목 추가</button>
      <!-- 마감일 및 시간 입력 -->
...
clog('My user_code : '+ user_code);
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (id == 'member') {
                    ...
                    crew_overview_select_member(response);
  ...
  function crew_overview_select_member(response) {
      ...
      for (var i in response) {
          ...
          list +=          '<span class="main-text" onClick="voteNow()" >크루수 제한건</span> ';
          ...
          list +=       '</div>';
          list +=       '<div class="text-container"> ';
          list +=          '<span class="main-text">크루장 위임건</span> ';
          list +=          '<span class="sub-text"></span>';
          list +=       '</div> ';
          list +=    '</div> ';
          list += '</li> ';
      }
