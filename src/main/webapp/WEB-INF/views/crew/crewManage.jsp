        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (flag == 1){
                    ...
                    detail_form += '   </div> ';
                    detail_form += '       <div class="notice_detail_name" id="notice_detail_name" name="notice_detail_name">글쓴이: 크루장</div>';
...
function resignTeam() {
    ...
    if (confirmation) {
        // 팀장(position == 1)인 경우, 탈퇴 불가
        if (position == 1) {
            alert("크루장 권한을 위임하지 않고는 탈퇴할 수 없습니다.");
            return false; // 탈퇴 중지
        }
